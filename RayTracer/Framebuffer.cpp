...
void Framebuffer::DrawPoint(int x, int y, const color_t& color)
{
	...
	destColor.r = ((color.r * alpha) + (destColor.r * invAlpha)) >> 8; // or / 255
	destColor.g = ((color.g * alpha) + (destColor.g * invAlpha)) >> 8; // or / 255
	destColor.b = ((color.b * alpha) + (destColor.b * invAlpha)) >> 8; // or / 255
